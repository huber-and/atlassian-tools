 ...
 *
 * This auto-generated API class provides methods for creating, updating, and managing
 * attachments in Confluence content. It wraps the Confluence REST API v1 endpoints
 * for attachment operations.
 *
 * Note: This class is auto-generated by OpenAPI Generator and may be regenerated
...
public class ContentAttachmentsApi extends BaseApi {
	...
	/**
	 * Constructs a ContentAttachmentsApi with the default API client.
	 */
	...
	/**
	 * Constructs a ContentAttachmentsApi with the given API client.
	 *
